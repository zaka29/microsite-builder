...
const SHOPIFY_DOMAIN =
  process.env.NEXT_PUBLIC_SHOPIFY_STORE_DOMAIN || process.env.SANITY_STUDIO_SHOPIFY_STORE_DOMAIN
...
export async function getProductsByIds(ids: string[]) {
  ...
  const globalIds = ids.map((id) => (id.startsWith('gid://') ? id : `gid://shopify/Product/${id}`))
